@php
    // Daftar jabatan Pengurus Alumni yang sudah ditentukan
    $positions = [
        'Ketua Umum',
        'Wakil Ketua',
        'Sekretaris',
...
<div class="mt-8 flex justify-end">
    <a href="{{-- route('admin.alumni-boards.index') --}}" class="text-gray-600 hover:underline py-2 px-4 mr-4">Batal</a>
