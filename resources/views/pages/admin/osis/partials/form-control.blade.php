@php
    ...
    $positions = [
        ...
        'Sekbid I: Keimanan dan Ketakwaan terhadap Tuhan YME',
        ...
        'Sekbid V: Prestasi Akademik, Seni, dan/atau Olahraga',
        'Sekbid VI: Keterampilan dan Kewirausahaan',
        'Sekbid VII: Kepedulian Sosial dan Lingkungan Hidup',
        'Sekbid VIII: Teknologi Informasi dan Komunikasi',
    ];
@endphp
...
<div class="mt-8 flex justify-end">
    <a href="{{ route('admin.pengurus-osis.index') }}" class="text-gray-600 hover:underline py-2 px-4 mr-4">Batal</a>
